...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]>
{
    ...
    private String getReadableDateString(long time){
        ...
        SimpleDateFormat shortenedDateFormat = new SimpleDateFormat("EEE"); // returns day of week (MON,TUE)
            ...
            throws JSONException
    {
        ...
        int loopLimit = weatherArray.length();
        if(loopLimit > 3) loopLimit = 3;
        ...
        for(int i = 0; i < loopLimit; i++) {
            ...
            double today = temperatureObject.getDouble("day");
            double low = temperatureObject.getDouble(OWM_MIN);

            double windSpeed = dayForecast.getDouble("speed");
            int windSpeedInt = (int) Math.round(windSpeed);

            int temperature = (int) Math.round(today);
            if(i != 0) temperature = (int) Math.round( (high + low)/2 );

            int dayNo = 1;
            if(day.equals("Mon")) dayNo = 1;
            else if(day.equals("Tue")) dayNo = 2;
            else if(day.equals("Wed")) dayNo = 3;
            else if(day.equals("Thu")) dayNo = 4;   // TODO confirm Thursday spelling
            else if(day.equals("Fri")) dayNo = 5;
            else if(day.equals("Sat")) dayNo = 6;
            else if(day.equals("Sun")) dayNo = 7;
            else dayNo = 1;
