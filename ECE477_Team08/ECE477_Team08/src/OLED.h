...
void drawTimeMenu(int hour, int mins)
{
	...
	drawDigit(hour/10, 10, 10, 54, 19, RED);
	drawDigit(hour%10, 10, 32, 54, 41, RED);
	draw_line(25,47,27,47, RED);
	draw_line(37,47,39,47, RED);
	drawDigit(mins/10, 10, 54, 54, 63, RED);
	drawDigit(mins%10, 10, 76, 54, 85, RED);
}
